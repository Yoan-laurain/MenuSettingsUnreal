...
UGameSettingsCollection* USettingsManager::InitializeAudioSettings()
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			{
				LocalSettings->SetOverallVolume(OverallItem->GetTechnicalOption<int>() / 100.f);
			} );
			...
			OverallItem->SetTechnicalOption<int>(TechnicalOption);
		...
		// 	{
		// 		LocalSettings->SetMusicVolume(MusicItem->GetTechnicalOption<int>()/100.f);
		// 	} );
		// 	
		...
		// 	}
		// 	MusicItem->SetTechnicalOption<int>(TechnicalOption);
		// 	
		...
		// 	{
		// 		LocalSettings->SetSoundFXVolume(EffectsItem->GetTechnicalOption<int>()/100.f);
		// 	} );
		// 	
		...
		// 	}
		// 	EffectsItem->SetTechnicalOption<int>(TechnicalOption);
		...
		// 	{
		// 		LocalSettings->SetDialogueVolume(VoiceItem->GetTechnicalOption<int>()/100.f);
		// 	} );
		// 	
		...
		// 	}
		// 	VoiceItem->SetTechnicalOption<int>(TechnicalOption);
